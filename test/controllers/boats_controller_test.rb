...
class BoatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create boat" do
    assert_difference('Boat.count') do
      post boats_url, params: { boat: { location: @boat.location, name: @boat.name, storage: @boat.storage, user_id: @boat.user_id } }
    end
  ...
  test "should update boat" do
    patch boat_url(@boat), params: { boat: { location: @boat.location, name: @boat.name, storage: @boat.storage, user_id: @boat.user_id } }
